...
// -----------弹窗们的状态变量-------------
    ...
    methods: {
         ...
         */
        toggleExpand() {
            console.log("Toggle expand clicked"); // 在控制台输出点击展开按钮的信息，用于调试
            this.isExpanded = !this.isExpanded; // 切换展开状态：如果之前是展开的，现在就收起；之前是收起的，现在就展开
        },
        ...
        * */
         ...
         * 控制主题图预览对话框的显示状态
         *
         * @param {boolean} val - 是否显示主题图预览对话框的值，true为显示，false为隐藏
         */
