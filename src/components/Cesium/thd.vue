...
<!--    </div>-->
<!--    &lt;!&ndash;   图层要素&ndash;&gt;-->
<!--    &lt;!&ndash;    <div v-if="activeComponent === 'layerChoose'" class="thd-listTable">&ndash;&gt;-->
<!--    &lt;!&ndash;      <div class="list-dialog" style="width: 100%;height: 100%; z-index: 900;">&ndash;&gt;-->
<!--    &lt;!&ndash;        <div class="list-dialog__header">&ndash;&gt;-->
<!--    &lt;!&ndash;          <span>图层要素</span>&ndash;&gt;-->
<!--    &lt;!&ndash;        </div>&ndash;&gt;-->
<!--    &lt;!&ndash;        <div class="list-dialog__content" style="height: calc(100% - 40px);">&ndash;&gt;-->
<!--    &lt;!&ndash;          <el-tree&ndash;&gt;-->
<!--    &lt;!&ndash;              v-model="selectedlayersLocal"&ndash;&gt;-->
<!--    &lt;!&ndash;              :data="layerTree"&ndash;&gt;-->
<!--    &lt;!&ndash;              show-checkbox&ndash;&gt;-->
<!--    &lt;!&ndash;              node-key="id"&ndash;&gt;-->
<!--    &lt;!&ndash;              ref="layerTree"&ndash;&gt;-->
<!--    &lt;!&ndash;              default-expand-all&ndash;&gt;-->
<!--    &lt;!&ndash;              highlight-current&ndash;&gt;-->
<!--    &lt;!&ndash;              :props="defaultProps"&ndash;&gt;-->
<!--    &lt;!&ndash;              @check-change="handleLayerTreeChange">&ndash;&gt;-->
<!--    &lt;!&ndash;          </el-tree>&ndash;&gt;-->
<!--    &lt;!&ndash;          <div @click="toggleExpand" style="text-align: center; margin-top: 10px; display: flex; justify-content: flex-end;">&ndash;&gt;-->
<!--    &lt;!&ndash;          </div>&ndash;&gt;-->
<!--    &lt;!&ndash;        </div>&ndash;&gt;-->
<!--    &lt;!&ndash;      </div>&ndash;&gt;-->
<!--    &lt;!&ndash;    </div>&ndash;&gt;-->
...
<!--          &lt;!&ndash;          &lt;!&ndash; 行政区划按钮 &ndash;&gt;&ndash;&gt;-->
<!--          &lt;!&ndash;          <div class="district-buttons" style="margin-top: 20px;">&ndash;&gt;-->
<!--          &lt;!&ndash;            <div class="city-button">&ndash;&gt;-->
<!--          &lt;!&ndash;              <el-button @click="addYaanImageryDistrict">雅安市</el-button>&ndash;&gt;-->
<!--          &lt;!&ndash;            </div>&ndash;&gt;-->
<!--          &lt;!&ndash;            <div class="city-button">&ndash;&gt;-->
<!--          &lt;!&ndash;              <el-button @click="backcenter">回到震中</el-button>&ndash;&gt;-->
<!--          &lt;!&ndash;            </div>&ndash;&gt;-->
<!--          &lt;!&ndash;          </div>&ndash;&gt;-->
<!--          &lt;!&ndash;          &lt;!&ndash; 下属区县按钮 &ndash;&gt;&ndash;&gt;-->
<!--          &lt;!&ndash;          <div class="district-buttons">&ndash;&gt;-->
<!--          &lt;!&ndash;            <div v-for="district in districts" :key="district.adcode" class="district-button">&ndash;&gt;-->
<!--          &lt;!&ndash;              <el-button @click="handleDistrictClick(district)">{{ district.name }}</el-button>&ndash;&gt;-->
<!--          &lt;!&ndash;            </div>&ndash;&gt;-->
<!--          &lt;!&ndash;          </div>&ndash;&gt;-->
...
<!--          <div class="time-progress" :style="{ width: `${currentTimePosition}%` }"></div>-->
<!--          <div class="time-slider" :style="{ left: `${currentTimePosition-0.5}%` }"></div>-->
<!--          &lt;!&ndash;          <div class="time-slider" :style="{ left: `${currentTimePosition}%` }"></div>&ndash;&gt;-->
<!--        </div>-->
<!--        &lt;!&ndash; speedButton 和 chooseSpeed 放在一起 &ndash;&gt;-->
<!--        <span class="speedButton">{{ speedOption }}</span>-->
<!--        <div class="chooseSpeed">-->
<!--          <option v-for="option in speedOptions" :key="option" @click="selectSpeed(option)">-->
<!--            {{ option }}-->
...
<!--      ></timeLineLegend>-->
<!--    </div>-->
<!--    &lt;!&ndash;    两侧组件 end&ndash;&gt;-->
<!--    &lt;!&ndash;展示弹框伤亡统计&ndash;&gt;-->
<!--    <layeredShowPlot :zoomLevel="zoomLevel" :pointsLayer="pointsLayer" />-->
<!--    <div id="legend" v-show="isShowYaanRegionLegend"-->
<!--         style="position: absolute;-->
<!--           z-index:20; bottom: 100px;-->
