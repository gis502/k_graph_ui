...
<!--    <div>-->
<!--        &lt;!&ndash;    地震列表切换&ndash;&gt;-->
<!--        &lt;!&ndash;    <div class="eqlist-button">&ndash;&gt;-->
<!--        &lt;!&ndash;      <el-button class="el-button&#45;&#45;primary" size="small" @click="toggleComponent('eqList')">地震列表</el-button>&ndash;&gt;-->
<!--        &lt;!&ndash;    </div>&ndash;&gt;-->
<!--        <div class="thd-eqtable" v-if="activeComponent === 'eqList'">-->
<!--            <eqTable :eqData="tableData"/>-->
<!--        </div>-->
...
<!--    &lt;!&ndash;   图层要素&ndash;&gt;-->
<!--    &lt;!&ndash;    <div class="layer-button">&ndash;&gt;-->
<!--    &lt;!&ndash;      <el-button class="el-button&#45;&#45;primary" size="small" @click="toggleComponent('layerChoose')">图层要素</el-button>&ndash;&gt;-->
<!--    &lt;!&ndash;    </div>&ndash;&gt;-->
...
<!--        &lt;!&ndash;    行政区划&ndash;&gt;-->
<!--        &lt;!&ndash;    <div class="regionjump-button">&ndash;&gt;-->
<!--        &lt;!&ndash;      <el-button class="el-button&#45;&#45;primary" size="small" @click="toggleComponent('Regionjump')">行政区划</el-button>&ndash;&gt;-->
<!--        &lt;!&ndash;    </div>&ndash;&gt;-->
...
<!--        &lt;!&ndash;      <el-button class="el-button&#45;&#45;primary" size="small" @click="takeScreenshot">报告产出</el-button>&ndash;&gt;-->
<!--        &lt;!&ndash;    </div>&ndash;&gt;-->
<!--        &lt;!&ndash;    <div class="thematic-button">&ndash;&gt;-->
<!--        &lt;!&ndash;      <el-button class="el-button&#45;&#45;primary" size="small" @click="">专题图下载</el-button>&ndash;&gt;-->
<!--        &lt;!&ndash;    </div>&ndash;&gt;-->
<!--        &lt;!&ndash;    <div class="back-button">&ndash;&gt;-->
<!--        &lt;!&ndash;      <el-button class="el-button&#45;&#45;primary" size="small" @click="backToHome">返回首页</el-button>&ndash;&gt;-->
<!--        &lt;!&ndash;    </div>&ndash;&gt;-->
...
<!--      <el-menu-item index="2" @click="toggleComponent('layerChoose')" style="width: 90px;">图层要素</el-menu-item>-->
<!--      <el-menu-item index="3" @click="toggleComponent('Regionjump')" style="width: 90px;">视角跳转</el-menu-item>-->
<!--&lt;!&ndash;      <el-menu-item index="4" @click="takeScreenshot" style="width: 100px;">分析图件产出</el-menu-item>&ndash;&gt;-->
<!--      <el-menu-item index="4" @click="toggleComponent('reportDownload')" style="width: 90px;">分析图件产出</el-menu-item>-->
<!--      <el-menu-item index="5" @click="toggleComponent('thematicMapDownload')" style="width: 90px;">专题图下载</el-menu-item>-->
<!--      <el-menu-item index="6">返回首页</el-menu-item>-->
<!--    </el-menu>-->
