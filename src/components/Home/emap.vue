...
<!--  <div>
    &lt;!&ndash;    工具&ndash;&gt;
    &lt;!&ndash;    <div class="tool_container">&ndash;&gt;
    &lt;!&ndash;      &lt;!&ndash;      <button @click="openTool('paintBrushTool')">画笔</button>&ndash;&gt;&ndash;&gt;
    &lt;!&ndash;      &lt;!&ndash;      <button @click="clearTool('paintBrushTool')">清除画笔</button>&ndash;&gt;&ndash;&gt;
    &lt;!&ndash;      &lt;!&ndash;      <button class="_btn" type="button" @click="clearMap()">清空所有</button>&ndash;&gt;&ndash;&gt;
    &lt;!&ndash;      <button @click="setMapStyle('black')" class="theme">black</button>&ndash;&gt;
    &lt;!&ndash;      <button @click="setMapStyle('indigo')" class="theme">indigo</button>&ndash;&gt;
    &lt;!&ndash;      <button @click="resetMapStyle" class="theme">恢复默认</button>&ndash;&gt;
    &lt;!&ndash;    </div>&ndash;&gt;
    &lt;!&ndash;指南针&ndash;&gt;
