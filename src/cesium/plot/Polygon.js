...
export default class Polygon {
  ...
  activate(name, type, img, eqid,resolve) {
    ...
    // this.entityCount = 0;
    this.type = type;
    this.img = 'http://81.70.200.28' +'/uploads/PlotsPic/' + img + '.png';
    this.plotType = img
        ...
        for (let i = 0; i < coords.length; i++) {
          ...
          window.viewer.entities.add({
            ...
            polygon: {
              ...
              material: 'http://81.70.200.28' +'/uploads/PlotsPic/' + polygon[0].icon + '.png?t=' + new Date().getTime(),
      ...
      onlyPlotid.forEach(onlyPlotidItem => {
        ...
        window.viewer.entities.add({
          ...
          ellipse: {
            ...
            material: new Cesium.ImageMaterialProperty({
              image: 'http://81.70.200.28' +'/uploads/PlotsPic/' + polygon[0].icon + '.png?t=' + new Date().getTime() ,
