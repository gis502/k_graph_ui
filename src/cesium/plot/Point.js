  ...
  drawPoint(data, bool) {
    ...
    if (bool) {
      ...
      window.viewer.entities.add({
        ...
        billboard: {
          image: 'http://172.26.86.82:8080/uploads/PlotsPic/' + data.icon+ '.png?t=' + new Date().getTime(),
          width: 50,
          height: 50,
      ...
      let img = 'http://172.26.86.82:8080/uploads/PlotsPic/' + data.icon+ '.png?t=' + new Date().getTime();
