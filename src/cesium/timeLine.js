...
let timeLine = {
    ...
    addMakerPoint(item, type) {
        ...
        //点的属性 震中点统用一一个方法
        let labeltext = null
        let img = 'http://47.92.216.173' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime()
    ...
    addPolyline(item, type) {
        ...
        if (window.viewer && window.viewer.entities) {
            ...
            let material = cesiumPlot.getMaterial(item.plotType, 'http://47.92.216.173' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime())
            ...
            if (item.plotType === "泥石流" || item.plotType === "滑坡" || item.plotType === "地面沉降" || item.plotType === "崩塌" || item.plotType === "地面塌陷") {
                ...
                window.viewer.entities.add({
                    ...
                    ellipse: {
                        ...
                        material: new Cesium.ImageMaterialProperty({
                            image: 'http://47.92.216.173' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime(),
                ...
                window.viewer.entities.add({
                    ...
                    polygon: {
                        ...
                        material: 'http://47.92.216.173' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime(),
    ...
    addPointLabel(data, labeltext) {
        ...
        if (labeldataSource) {
            ...
            labeldataSource.entities.add({
                ...
                labeltext: labeltext,
                billboard: {
                    image: 'http://47.92.216.173' + '/uploads/PlotsPic/' + data.icon + '.png?t=' + new Date().getTime(),
                    width: 50, // 图片宽度,单位px
                    height: 50, // 图片高度，单位px
