...
let timeLine = {
    ...
    addMakerPoint(item, type) {
        ...
        //点的属性 震中点统用一一个方法
        let labeltext = null
        let img = 'http://81.70.200.28' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime()
    ...
    addPolyline(item, type) {
        ...
        if (window.viewer && window.viewer.entities) {
            ...
            let material = cesiumPlot.getMaterial(item.plotType, 'http://81.70.200.28' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime())
            ...
            if (item.plotType === "泥石流" || item.plotType === "滑坡" || item.plotType === "地面沉降" || item.plotType === "崩塌" || item.plotType === "地面塌陷") {
                ...
                window.viewer.entities.add({
                    ...
                    ellipse: {
                        ...
                        material: new Cesium.ImageMaterialProperty({
                            image: 'http://81.70.200.28' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime(),
                ...
                window.viewer.entities.add({
                    ...
                    polygon: {
                        ...
                        material: 'http://81.70.200.28' + '/uploads/PlotsPic/' + item.icon + '.png?t=' + new Date().getTime(),
