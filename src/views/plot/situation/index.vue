...
<!--              <img :src="'http://59.213.183.7/prod-api/' +'/uploads/PlotsPic/' +item.img+ '.png?t=' + new Date().getTime()">-->
              <img :src="'http://81.70.200.28'+'/uploads/PlotsPic/' +item.img+ '.png?t=' + new Date().getTime()"
...
<!--        <img :src="'http://59.213.183.7/prod-api/' +'/uploads/PlotsPic/' +scope.row.icon+ '.png?t=' + new Date().getTime()">-->
            <img :src="'http://81.70.200.28'+'/uploads/PlotsPic/' +scope.row.icon+ '.png?t=' + new Date().getTime()"
...
export default {
  ...
  methods: {
    ...
    treeItemClick(item) {
      ...
      this.messageIcon = 'http://81.70.200.28' +'/uploads/PlotsPic/' + item.img + '.png?t=' + new Date().getTime()
