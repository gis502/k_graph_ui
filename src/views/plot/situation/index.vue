...
<!--              <img :src="'http://59.213.183.7/prod-api/' +'/uploads/PlotsPic/' +item.img+ '.png?t=' + new Date().getTime()">-->
              <img :src="'http://47.92.216.173:81'+'/uploads/PlotsPic/' +item.img+ '.png?t=' + new Date().getTime()"
...
export default {
  ...
  methods: {
    ...
    treeItemClick(item) {
      ...
      this.messageIcon = 'http://47.92.216.173:81' +'/uploads/PlotsPic/' + item.img + '.png?t=' + new Date().getTime()
