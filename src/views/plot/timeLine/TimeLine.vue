  ...
  methods: {
    init() {
      ...
      getEqListById({id: this.eqid}).then(res => {
        ...
        // timeLine.MiniMapAddMakerPoint(smallViewer, this.centerPoint.startTime, this.centerPoint.endTime, this.centerPoint.longitude, this.centerPoint.latitude, 0, centerstar, this.centerPoint.earthquakeName, this.centerPoint.plotId, this.centerPoint.plotType, "震中")
        // smallViewer.entities.add({
        //   availability: new Cesium.TimeIntervalCollection([new Cesium.TimeInterval({
        //     start: Cesium.JulianDate.fromDate(new Date(this.centerPoint.startTime)),
        //     stop: Cesium.JulianDate.fromDate(new Date(this.centerPoint.endTime))
        //   })]),
        ...
        //   plottype: this.centerPoint.plotType,
        //   layer: "震中"
        // })
